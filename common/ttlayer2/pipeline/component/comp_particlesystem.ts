...
export class Comp_ParticleSystem implements ISceneComponent, ISceneRenderItem {
    ...
    private InitInstMesh() {
        ...
        let instcount = 65536;
        let vertexdata = new Uint8Array(stride * instcount);
